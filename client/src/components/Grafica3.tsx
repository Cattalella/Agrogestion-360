...
export const Grafica3 = ({ pagosRealizados = 0, totalTrabajadores = 0 }: Grafica3Props) => {
    ...
    // Lógica de porcentajes basada en las props recibidas
    const porcentajeTotal = totalTrabajadores > 0 ? 100 : 0;
    const porcentajePagos = totalTrabajadores > 0 ? (pagosRealizados / totalTrabajadores) * 100 : 0;
