...
// 1. Definimos qué datos necesita recibir este componente (Props)
interface FormularioCerdoProps {
    sugerenciaId: string;
    categoriaSeleccionada: string;
    setCategoria: (valor: string) => void;
    // onGuardar ahora acepta el objeto y un booleano para saber si cerrar el modal
...
export const FormularioCerdo = ({ 
    ...
    setCategoria, 
    onGuardar 
}: FormularioCerdoProps) => { // <-- Cambiado de FormularioGanadoProps a FormularioCerdoProps
